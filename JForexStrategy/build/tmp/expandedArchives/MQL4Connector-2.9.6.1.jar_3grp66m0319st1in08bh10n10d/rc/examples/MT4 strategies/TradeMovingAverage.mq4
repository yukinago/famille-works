...
int lastOpenCheckTime = 0;
int lastCloseCheckTime = 0;
//+------------------------------------------------------------------+
...
//---- go trading only for first tick of new bar
		if(lastOpenCheckTime == Time[0]){
			return;
		}
		lastOpenCheckTime = Time[0];
//---- get Moving Average 
...
//---- go trading only for first tiks of new bar
		if(lastCloseCheckTime == Time[0]){
			return;
		}
		lastCloseCheckTime = Time[0];
//---- get Moving Average 
   ma=iMA(NULL,0,MovingPeriod,MovingShift,MODE_SMA,PRICE_CLOSE,0);
//----
   for(int i=0;i<OrdersTotal();i++)
